...
{if NOT empty($entries)}{* catch a staticpage startpage which has no $entries array set *}
    ...
    <div class="serendipity_Entry_Date">
        ...
        {if NOT $is_preview AND $template_option.entryfooterposition === true}
            ...
            {if NOT empty($entry.categories)}
                ...
                {if $dategroup.is_sticky}{$entry.timestamp|formatTime:DATE_FORMAT_ENTRY}{else} {$entry.timestamp|formatTime:'%H:%M'}{/if}
            {/if}<br>
    ...
    {if NOT $is_preview AND $template_option.entryfooterposition === false}
    ...
    {/if}
            ...
            {/if}
                {if NOT $dategroup@last}<hr class="entry_separator"/>{/if}
            </div>
...
{/if}
        ...
        {if $is_single_entry AND NOT $is_preview}
            ...
            <div class="serendipity_comments serendipity_section_trackbacks">
                ...
                <div id="serendipity_trackbacklist" class="commentlist">
            ...
            <div class="serendipity_comments serendipity_section_comments">
                ...
                <div id="serendipity_commentlist" class="commentlist">
