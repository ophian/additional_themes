...
@define('INFO_TAB', '<p style="color:#FFFFFF; background-color: gray"><b> OKNO ZÁLO®KY</b></p>');
...
@define('INFO_TABNUGAMOUNT', '<p style="color:#ffffff; background-color:orange"><b> Zálo¾ka NUG OKNA (políèka pro zadání zálo¾ek naleznete zde po znovunaètení stránky)</b></p>');
...
@define('TABNUG_AMOUNT', 'Poèet oken pro zálo¾ky NUG');
...
@define('TABNUG_POSITION', 'Poloha zálo¾ky:');
@define('TABNUG_HEIGHT', 'Nadpis zálo¾ky:');
