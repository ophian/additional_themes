...
@define('INFO_TABNUGAMOUNT', '<p style="color:#ffffff; background-color:orange"><b> Záložka NUG OKNA (políčka pro zadání záložek naleznete zde po znovunačtení stránky)</b></p>');
@define('INFO_SBARMENUESAMOUNT', '<p style="color:#ffffff; background-color:red"><b> Přídavná menu (políčka pro zadání menu zde naleznete po znovunačtení stránky)(</b></p>');
@define('INFO_HMENUE', '<p style="color:#ffffff; background-color:#0066FF"><b> Vodorovné menu (políčka pro zadání menu zde naleznete po znovunačtení stránky)</b></p>');
@define('TABNUG_AMOUNT', 'Počet oken pro záložky NUG');
@define('CATBANNER_AMOUNT', 'Počet bannerů kategorií');
@define('NUGWIN_NAME', 'jedinečné jméno');
...
@define('INFO_CBA_AMOUNT', '<p style="color:#ffffff; background-color:olive"><b> banner kategorie (políčka pro zadání kategorií zde naleznete po znovunačtení stránky)</b></p>');
