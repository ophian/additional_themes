...
<style type="text/css">
  ...
  {foreach $tabklotz1 AS $tabklotz2}
    ...
    <ul >
          {foreach $sbmenue1 AS $sbmenue2}
           ...
           {if $sbmenue2.position=="2"}
            ...
            <ul>
              {foreach $sbmenue2.menuepoints AS $menue2}
...
{foreach $tabklotz1 AS $tabklotz2}
 ...
 {assign var="windowprint" value="0"}
                ...
                {foreach $tabklotz2.tabs AS $tab2}
  ...
  <div class="arrowlistmenu">
                          {foreach $sbmenue1 AS $sbmenue3}
                           {if $sbmenue3.position=="0"}
                            ...
                            <ul>
                              {foreach $sbmenue3.menuepoints AS $menue3}
 ...
 <div id="footerframe"  >
  ...
  {if $template_option.enablefooter == 'true'}
   ...
   <div id="footerbox1">
         ...
         {foreach $tabklotz1 AS $tabklotz2}
              {assign var="windowprint" value="0"}
                     {foreach $tabklotz2.tabs AS $tab2}{if $tabklotz2.position=="7"} {if $windowprint=="0"}  {assign var="windowprint" value="1"} <div class="tabcontainer">  <ul class="tabnav"> {/if} <li><a href="#{$tab2.title}"> {$tab2.title} </a></li>  {/if} {/foreach}
                     {if $windowprint=="1"} </ul> <div class="tabcontents {$tabklotz2.tabklotzname}">  {/if}
                       {foreach $tabklotz2.tabs AS $tab2}{if $tabklotz2.position=="7"}<div class="content" id="{$tab2.title}"><h2>{$tab2.title}</h2><p>{$tab2.tabstext} </p> </div> {/if} {/foreach}
           ...
           {/foreach}
              ...
              {foreach $sbmenue1 AS $sbmenue3}
                 {if $sbmenue3.position=="7"}
                    <h3 class="headerbar"><a  href="{$sbmenue3.href}" title="{$sbmenue3.title} "{if $sbmenue3.target=='true'} target="_blank"{/if}>{$sbmenue3.title}</a></h3>
                    <ul> {foreach $sbmenue3.menuepoints AS $menue3}<li><a href="{$menue3.href}" title="{$menue3.title}"{if $menue3.target=='1'} target="_blank"{/if}{if $menue3.target=='2'} target="_blank" rel="nofollow"{/if}>{$menue3.title}</a></li> {/foreach}</ul>
                 {/if}
              {/foreach}
...
<!-- /#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: -->
   ...
   <div id="footerbox2">
         ...
         {foreach $tabklotz1 AS $tabklotz2}
             {assign var="windowprint" value="0"}
                     {foreach $tabklotz2.tabs AS $tab2} {if $tabklotz2.position=="8"} {if $windowprint=="0"}  {assign var="windowprint" value="1"} <div class="tabcontainer">  <ul class="tabnav"> {/if} <li><a href="#{$tab2.title}"> {$tab2.title} </a></li>  {/if} {/foreach}
                     {if $windowprint=="1"} </ul> <div class="tabcontents {$tabklotz2.tabklotzname}">  {/if}
                     {foreach $tabklotz2.tabs AS $tab2} {if $tabklotz2.position=="8"}<div class="content" id="{$tab2.title}"><h2>{$tab2.title}</h2> <p>{$tab2.tabstext} </p></div> {/if}{/foreach}
...
<!-- /#:::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: -->
   ...
   <div id="footerbox3">
         ...
         {foreach $tabklotz1 AS $tabklotz2}
             {assign var="windowprint" value="0"}
                     {foreach $tabklotz2.tabs AS $tab2} {if $tabklotz2.position=="9"} {if $windowprint=="0"}  {assign var="windowprint" value="1"} <div class="tabcontainer">  <ul class="tabnav"> {/if} <li><a href="#{$tab2.title}"> {$tab2.title} </a></li>  {/if} {/foreach}
                     {if $windowprint=="1"} </ul> <div class="tabcontents {$tabklotz2.tabklotzname}">  {/if}
                     {foreach $tabklotz2.tabs AS $tab2} {if $tabklotz2.position=="9"}<div class="content" id="{$tab2.title}"><h2>{$tab2.title}</h2> <p>{$tab2.tabstext} </p></div> {/if}{/foreach}
