...
@define('ENTRY_POSTED_BY', 'Posted by');
@define('FILED_UNDER', 'and filed under');
...
@define('PAGE_WIDTH', 'Page width (76em)');
@define('CONTENT_WIDTH', 'Content width (40em)');
@define('SIDEBAR_WIDTH', 'Sidebar width (20em)');
@define('SIDEBAR_NAVIGATION_TITLE', 'Title of sidebar navigation (empty to disable usage)');
