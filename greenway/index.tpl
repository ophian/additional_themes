...
{/if}
 ...
 <div id="right_side">
             <div class="pad">
             <img src="{$serendipityBaseURL}templates/greenway/images/pic{foreach $navlinks AS $navlink}{if $navlink.href==$smarty.server.REQUEST_URI}{$navlink.picture}{/if}{/foreach}{$category_info.categoryid}.jpg" alt="" />
