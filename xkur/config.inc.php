...
$serendipity['smarty']->assign('tab1_cat', ( str_replace('&nbsp;', '', trim(($catsel[$template_loaded_config['catx1']] ?? ''))) ));
$serendipity['smarty']->assign('tab2_cat', ( str_replace('&nbsp;', '', trim(($catsel[$template_loaded_config['catx2']] ?? ''))) ));
$serendipity['smarty']->assign('tab3_cat', ( str_replace('&nbsp;', '', trim(($catsel[$template_loaded_config['catx3']] ?? ''))) ));
