...
@define('MORE', 'more');
@define('ABOUT_URL', 'Enter the URL of your about page eg \'http://www.somesite.com\'');
@define('ABOUT_TITLE', 'About title');
@define('ABOUT_TITLE_DESC', 'Add the title for your about box');
