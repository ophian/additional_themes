    ...
    <div class="serendipity_Entry_Date">
        ...
        <div class="serendipity_entry serendipity_entry_author_{$entry.author|makeFilename} {if $entry.is_entry_owner}serendipity_entry_author_self{/if}">
            ...
            <div class="serendipity_entryFooter">
                ...
                {if $entry.categories}
                   {$CONST.IN} {foreach $entry.categories AS $category}<img src='{serendipity_getFile file="img/arrow_right-01.png"}' alt="" /> <a href="{$category.category_link}">{$category.category_name|escape}</a>{if NOT $entry_category@last}, {/if}{/foreach}
                {/if}
