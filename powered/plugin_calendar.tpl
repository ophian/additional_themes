<table class="serendipity_calendar">
    <tr>
        <td colspan="1" class="serendipity_calendarHeader">
...
{if $plugin_calendar_head.maxScroll ge $plugin_calendar_head.month_date}
            <a title="{$CONST.FORWARD}" href="{$plugin_calendar_head.uri_next}"><img alt="{$CONST.FORWARD}" src="{serendipity_getFile file="img/forward.gif"}"></a>
{/if}
        </td>
    </tr>
