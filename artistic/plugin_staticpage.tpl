...
<div class="entry_heading">
    <h3 class="entry_title">{/if}<a href="#">{$staticpage_headline|escape}</a></h3>
    <p class="entry_date">{if $staticpage_articleformat}{$staticpage_articleformattitle|escape}{/if}</p>
</div>
