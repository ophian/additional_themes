{if $is_embedded != true}
    ...
    {* Smarty var $is_html did use this in the old days... XHTML 1.0 Transitional is basically HTML 4.01 Transitional reworked as XML .... so is_xhtml(false) would have used
...
{if $is_raw_mode != true}
    ...
    <div id="skiplinks">
        <ul>
            ...
            <li lang="en"><a href="{if NOT empty($serendipityArchiveURL)}{$serendipityArchiveURL}{else}{$serendipityHTTPPath}archives/"{/if}">Skip to archive page</a></li>
