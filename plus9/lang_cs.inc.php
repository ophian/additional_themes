...
@define('J_TO', 'pro');
@define('NAVLINK_AMOUNT', 'Zadejte poèet odkazù v navigaèní lištì (pak je tøeba znovu natáhnout stránku Správa stylù)');
...
@define('ENABLE_LOG','Zobrazit pøihlášení v menu');
...
@define('MY_ADDTHIS_ACCOUNT','Váš addthis úèet. Pokud ho nemáte, mùžete si ho založit na http://www.addthis.com');
