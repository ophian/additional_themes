...
@define('ENABLE_LOG', 'Show  login in menu');
@define('DRNAV_LINK_TEXT', 'Text Drop Down-Link');
@define('DRNAV_LINK_URL', 'URL  Drop Down-Link');
@define('STAT_HEADER', 'Headline drop down menu for static pages');
@define('ENABLE_AD', 'Enable addthis button?');
@define('MY_ADDTHIS_ACCOUNT', 'Your addthis account. If you don´t have one goto addthis.com ');
