...
<h2 class="serendipity_title"><a href="#">{$staticpage_headline|escape}</a> <span class="fade">{if $staticpage_articleformat}{$staticpage_articleformattitle|escape}{/if}</span></h2>
