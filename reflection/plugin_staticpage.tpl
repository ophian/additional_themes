...
<h3 class="serendipity_title">{$staticpage_articleformattitle|escape}: {/if}<a href="#">{$staticpage_headline|escape}</a></h3>

{if $staticpage_navigation AND $staticpage_shownavi}
<div class="staticpage_navigation">
    <table width="100%">
        <tr>
            <td class="staticpage_navigation_left"   style="width: 20%: text-align:left;"><a href="{$staticpage_navigation.prev.link}" title="prev">{$staticpage_navigation.prev.name|escape}</a></td>
