...
{if $staticpage_navigation}
    <table border="0" cellpadding="2" cellspacing="2" width="96%" class="staticpage_navigation">
        <tr>
            <td class="staticpage_navigation_left" style="width: 20%">{if $staticpage_navigation.prev.link}<a href="{$staticpage_navigation.prev.link}" title="prev">&laquo; {$staticpage_navigation.prev.name|escape}</a>{/if}</td>
            ...
            <td class="staticpage_navigation_right" style="width: 20%; text-align: right">{if $staticpage_navigation.next.link}<a href="{$staticpage_navigation.next.link}" title="next">{$staticpage_navigation.next.name|escape} &raquo;</a>{/if}</td>
        </tr>
    </table>
{/if}
...
{if $staticpage_author}
    <br /><div class="staticpage_author">{$staticpage_author|escape}</div>
{/if}
